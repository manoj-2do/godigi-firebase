...
const buildCreateTaskDocV2 = (body) => {
    ...
    return {
        doc: {
            ...
            driver_code: String(body.driver_code),
            ab_driver_assignment_code: String(body.ab_driver_assignment_code),
...
module.exports = { buildCreateTaskDocV2 };
